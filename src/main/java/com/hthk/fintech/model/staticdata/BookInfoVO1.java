...
@FieldOrder({"legalEntity", "name", "id",
        "tradingDesk", "businessType", "tradingType",
        "business", "companyShortName", "department",
        "system", "tradingDeskRisk", "riskTeam",
        "riskSubTeam", "bbTraderPortfolio", "baseCurrency",
        "location", "endOfDay", "holidays"})
